...
- Added a protected FakeCo-only AWS owner for one private ARM64 EC2 instance, with exact account and resource replay, change-set-first updates, bounded SSM operations, and retained-data teardown.
