...
Source builds use Go 1.27.1, Node.js 24 or newer, and pnpm 12.5.1. The module minimum remains Go 1.26.6 so managed CodeQL can build with its preinstalled compiler; the `toolchain` directive selects Go 1.27.1 for normal builds.
