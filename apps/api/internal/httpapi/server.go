...
func (s *Server) Handler() http.Handler {
	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Get("/bots/self/questions", s.listBotQuestions)
		...
		r.Post("/messages/{message_id}/question/answers", s.answerQuestion)
		r.Post("/messages/{message_id}/question/resolution", s.resolveQuestion)
