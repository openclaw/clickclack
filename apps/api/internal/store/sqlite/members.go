...
func (s *Store) ListWorkspaceMemberPage(ctx context.Context, workspaceID, actorUserID string, page store.WorkspaceMemberPageRequest) (store.WorkspaceMemberPage, error) {
	...
	return sqliteWorkspaceMemberPageFromRows(workspaceID, req, rows)
}

func sqliteWorkspaceMemberPageFromRows(workspaceID string, req store.WorkspaceMemberPageRequest, rows []storedb.ListWorkspaceMemberPageRow) (store.WorkspaceMemberPage, error) {
